...
## ======================================INPUT MASK============================================================
  ...
  CP = c(10,20,30,40,50)                                 #No. of Cost Pools
  COR = c(0.6)                              #Correlation between resources
  RC_VAR =  c(0.2,0.4,0.6,0.8,0.9)                          #Resource cost variation --> base for DISP2 (ABL2019) (0.2)
  Q_VAR = c(0.4)                            #Demand variation
  Error = c(0.1,0.3,0.5,0.7)                              #Measurement error (BHL2011)
