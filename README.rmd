...
```{r INIT error measure and output file creation, eval = FALSE}
...
Eventually and output file is prduced which contains necessary model parametes that were applied within the peticular run of the model as well as the calculated error methods.

```{r creating output file, eval = FALSE}
