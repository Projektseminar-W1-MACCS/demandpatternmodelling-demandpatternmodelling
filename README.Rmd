...
Noting that the sum of the small resources must be equal **(1-DISP2) * TC**. In addition with the condition, that the costwise smallest of the big resources is larger or equal to the costwise biggest of the small resources. Therefore the minimum allowable costs for the big resources is the 
