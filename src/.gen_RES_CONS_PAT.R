...
RES_CONS_PATp <- (RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/ colSums(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)


#transposed Matrix is not equal to not-transposed Matrix -> why? 

t(t(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/rowSums(t(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)))==(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/ colSums(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)
colSums(t(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/rowSums(t(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND))) == rowSums((RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/ colSums(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND))
...
#Average distance 
RES_CONS_PATp1 = t(t(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/rowSums(t(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND))) # CHECKED 19/09/12
FIRM$PRODUCTION_ENVIRONMENT$RES_CONS_PATp1 = RES_CONS_PATp1
