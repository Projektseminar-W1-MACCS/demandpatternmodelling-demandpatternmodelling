...
#RES_CONS_PAT <- RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND
##INDIVIDUAL REQUIREMENTS OF THE PRODUCTS * DEMAMD / TRU (Currently like this in Anand et al. 2019)
RES_CONS_PAT <- (RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)/ colSums(RES_CONS_PAT*FIRM$PRODUCTION_ENVIRONMENT$DEMAND)
