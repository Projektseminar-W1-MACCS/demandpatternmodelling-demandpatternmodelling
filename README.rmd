...
The costing system consists of two functional requirements. As the number of cost pools is already defined by the modeler in the imputs, the next step is to allocate resource to the cost pools and after that, select a driver for each cost pool. 
